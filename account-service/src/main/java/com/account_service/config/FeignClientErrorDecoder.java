...
import com.account_service.exception.GlobalException;
...
public class FeignClientErrorDecoder implements ErrorDecoder {
    ...
    public Exception decode(String s, Response response) {
        ...
        if (response.status() == 403) {
            log.error("Forbidden request went through feign client: {}", globalException.getErrorMessage() + " - " + globalException.getErrorCode());
            return globalException;
        }
